package net.le.tourism.authority.constant;
...
public class Constants {
     ...
     * 管理员ID
     */
    public static final String LOGIN_ID = "adminId";

    /**
     * 管理员编号
     */
    public static final String LOGIN_NUM = "adminNum";
    /**
     * 管理员姓名
     */
    public static final String LOGIN_NAME = "adminName";
